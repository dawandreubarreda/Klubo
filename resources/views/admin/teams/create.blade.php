...
@section('title', 'Crear Equipo - Klubo')
    ...
    <form method="POST" action="{{ route('admin.teams.store') }}">
        ...
        <div style="margin-bottom: 1rem;">
            ...
            <select id="gender" name="gender" required 
                ...
                <option value="mixto" {{ old('gender') == 'mixto' ? 'selected' : '' }}>Mixto</option>
            </select>
        </div>

        <button type="submit" class="btn" style="background: #1e40af; color: white;">Crear Equipo</button>
